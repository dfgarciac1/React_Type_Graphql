    ...
    initEmbeddables(meta, embeddedProp) {
        ...
        for (const prop of Object.values(embeddable.properties)) {
            ...
            if (meta.properties[name] !== undefined) {
                throw new errors_1.MetadataError(`Property ${meta.name}:${name} is being overwritten by its child property ${embeddedProp.name}:${name}. Consider using a prefix to overcome this issue.`);
            }
